...
return{
	...
	add_tuna: function(req, res){
        ...
        exec('docker exec -w "/root/libest" -e "LD_LIBRARY_PATH=/usr/local/pqpki-openssl1.0.2o/lib" -e "PATH=/usr/local/pqpki-openssl1.0.2o/bin:$PATH" cli bash validate', function(err, stdout, stderr) {
           console.log(stdout);
                       });
