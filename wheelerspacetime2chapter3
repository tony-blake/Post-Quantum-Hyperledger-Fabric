...
(c) Speed: v = 0.6.
•
(d) Time in rocket frame: 15 years * sqrt(1 - 0.6^2) = 12 years. This calculation uses time dilation and the formula t' = t * sqrt(1-v^2). The time in the rocket frame is the proper time which is always less than the time measured by observers in the lab frame.
...
These solutions provide a comprehensive overview of the exercises in Chapter 3. Remember that some exercises are conceptual and require thought and discussion rather than a simple numerical answer.
